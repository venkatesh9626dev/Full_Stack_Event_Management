...
class Event_Request_Validation:
    ...
    def check_event_datetime(self, event_datetime):
        ...
        elif event_datetime["event_start_date_time"] == event_datetime["event_end_date_time"]:
    ...
    def check_participant_details(self,participant_details):
        ...
        print(participant_type == generic_enum.Participant_Enum.INDIVIDUAL
    ...
    def validate_data(self, event_data):
        ...
        participant_data_error = self.check_participant_details({"participant_type" : event_data["participant_type"],"participant_count" : event_data["participant_count"]})

        ticket_data_error = self.check_ticket_details({"ticket_type" : event_data["ticket_type"],"ticket_fare" : event_data["ticket_fare"]})
        
        datetime_data_error = self.check_event_datetime({"event_start_date_time" : event_data["event_start_date_time"],"event_end_date_time" : event_data["event_end_date_time"]})
