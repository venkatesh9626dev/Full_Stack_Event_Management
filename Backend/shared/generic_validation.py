...
class Schema_Validation:
    ...
    def check_participant_details(participant_details):
        ...
        if participant_type == generic_enum.Participant_Enum.GROUP and  (participant_count == None or participant_count == 1) :
            raise ValueError("Group participant event need the participants count or the count should be greater than 1")  
        
        elif participant_type ==generic_enum.Participant_Enum.INDIVIDUAL and participant_count > 1:
